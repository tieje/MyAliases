...
{
    printf "alias shebangs='printf \"#!/usr/bin/env bash\" >> ./*.sh  && chmod u+x ./*'\n"
    printf "alias bangs='printf \"#!/usr/bin/env bash\" >> ./* && chmod u+x ./*'\n"
    printf "alias pybangs='printf \"#!/usr/bin/python3\" >> ./*.py && chmod u+x ./*'\n"
    printf "alias jsbangs='printf \"#!/usr/bin/node\" >> ./*.js && chmod u+x ./*'\n"
